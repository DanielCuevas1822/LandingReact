    ...
    <div className="container">
      <Link to={newTo}>
        <div className="row person">
          <div className="col-12 col-md-5 col-lg-4 person__img">
            <img src={image} alt="person" />
          </div>
          <div className="col-12 col-md-7 col-lg-6 person__details">
            ...
            <p className="person__description">
              ...
              consequat sapien turpis, vel ullamcorper nunc lacinia vel.
            </p>
